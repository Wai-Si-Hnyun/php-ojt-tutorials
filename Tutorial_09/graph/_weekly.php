<?php
    ...
    $weeklyData = $db->processWeeklyData($data);
...
<body>
    <div class="container mt-3 d-flex justify-content-between">
        ...
        <div class="d-flex justify-content-evenly">
            <a href="_weekly.php" class="btn active btn-outline-secondary me-2">Weekly</a>
            <a href="_monthly.php" class="btn btn-outline-secondary me-2">Monthly</a>
    ...
    <script>
        <?php
            echo "const data = " . json_encode($weeklyData) . ";\n";
        ?>
